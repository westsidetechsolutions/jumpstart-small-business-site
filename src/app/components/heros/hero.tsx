    ...
    return (
        <div className="py-12 mx-auto max-w-7xl lg:py-24">
            <div className="flex flex-wrap items-center mx-auto max-w-7xl">
                <div className="flex flex-col items-start mt-12 mb-16 text-left lg:flex-grow lg:w-1/2 lg:mb-0">
                    <h1 className="mb-8 text-4xl font-bold leading-none tracking-tighter text-primary lg:text-5xl">Effortless Small Business Launch Packages</h1>
                    ...
                    <div className="mt-0 lg:mt-6 max-w-7xl sm:flex">
                        <div className="mt-3 rounded-lg sm:mt-0">
                            <LinkButton link="#pricing-cards" text="Learn More" />
                        </div>
                    </div>
                </div>
