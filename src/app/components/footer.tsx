    ...
    return (
        <footer className="p-4 bg-primary text-primary-content md:p-8 lg:p-10">
            <div className="mx-auto max-w-screen-xl text-center">
                <a href="#" className="flex justify-center items-center text-2xl font-semibold text-primary-content">
                ...
                <p className="my-6 text-primary-content">Open-source library of over 400+ web components and interactive elements built for better web.</p>
                <ul className="flex flex-wrap justify-center items-center mb-6 text-accent">
                    <li>
                ...
                <span className="text-sm text-primary-content sm:text-center">© 2021-2022 <a href="#" className="hover:underline">Flowbite™</a>. All Rights Reserved.</span>
            </div>
        </footer>
    )
}
