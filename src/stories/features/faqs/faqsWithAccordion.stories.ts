...
import FAQsWithAccordion, { Collapse } from '@/app/components/features/faqs/faqsWithAccording';

const meta: Meta<typeof FAQsWithAccordion> = {
  title: 'Features/FAQs/FAQsWithAccordion',
  component: FAQsWithAccordion,
  subcomponents: { Collapse },
  tags: ['autodocs'],
};

export default meta;

type Story = StoryObj<typeof FAQsWithAccordion>;
